function scriptV24Wclosed2DRWHistBatch(num, L, W, wTop, wBot)
        
tic
        batch = [100 250 500 750 1000 2500 5000 7500 10000 25000 50000 75000 100000 250000 500000 750000 1000000];
            
        fprintf('Initializing...');
        mkdir(strcat('/home/amg188/MATLAB/results/FourWindow/Group', num2str(num)))
        ...
        filename = strcat('/home/amg188/MATLAB/results/FourWindow/Group', ' ', num2str(num), '/hist', num2str(batch(a)), '_1.txt');
