...
function V2closed2DRWHistBatch()
...
staticS = uicontrol('Style', 'text', 'Position', [675 400 50 30], 'String', 'Batch = ');
editeS = uicontrol('Style', 'edit', 'String', '.000005', 'Position', [725 400 50 31]);
% staticS = uicontrol('Style', 'text', 'Position', [775 400 50 30], 'String', 'End = ');
% editeS = uicontrol('Style', 'edit', 'String', '.00001', 'Position', [825 400 50 31]);
...
ylabel('Y Position');
    ...
    function histogram(source, eventdata)
        ...
        bins = 0.00005:size(histArray)/10:max(histArray);
        figure(f3)
        hist(histArray, bins);
        ...
        filename = strcat('./2D Analysis/Square/Eta = 1.000e-3/Group 10 (9.5 micron x 9.5 micron _ 1.9 micron R1)/hist', num2str(batch(a)), '_1.fig');
