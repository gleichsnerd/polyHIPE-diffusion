...
%     end
    ...
    function updateGraph(source, eventdata)
        ...
        hold off;
        plot(-wTop/2, L, 'ro', wTop/2, L, 'ro', -wBot/2, 0, 'ro', wBot/2, 0, 'ro', [-W/2, -W/2, W/2, W/2], [-L/2, L + L/2, L + L/2, -L/2], 'bo');
        hold on;
        plot([-wBot/2, -W/2,-W/2], [0, 0, L/2 - wTop/2], 'r-', [-W/2, -W/2, -wTop/2], [L/2 + wTop/2, L, L], 'r-', [wTop/2, W/2, W/2], [L, L, L/2 + wTop/2], 'r-', [W/2, W/2, wBot/2], [L / 2 - wTop/2, 0, 0], 'r-' );        
        hold on;
        plot([-W + wBot/2, -W/2, -W/2],[0, 0, -L/2 + wTop/2], 'r-', [W - wBot/2, W/2, W/2], [0, 0, -L/2 + wTop/2], 'r-',[-W + wBot/2, -W/2, -W/2], [L, L, L + L/2 - wTop/2], 'r-', [W - wBot/2, W/2, W/2], [L, L, L + L/2 - wTop/2], 'r-');
        axis([-W W -L/2 (L/2 + L)]);
        hold on;
